"""DeepSeek model implementation via Vertex AI."""
...
class DeepSeekModel(BaseLLMModel):
    """DeepSeek model implementation using Vertex AI Publisher Model API."""

    def __init__(
        self,
        model_name: str = "deepseek-ai/deepseek-v3.1-maas",
        ...
        **kwargs
        ...
        """Initialize DeepSeek model via Vertex AI."""
    ...
    def initialize(self) -> None:
        """Initialize the DeepSeek model via Vertex AI."""
